  ...
  try {
    const res = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are a helpful medicine assistant for eDrugs.pk, a Pakistani online pharmacy. Provide accurate, concise answers. Use bullet points when listing items. Keep responses under 200 words.' },
